...
class Metaclass_Gripper_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('gripper_interface')
        except ImportError:
            import logging
            import traceback
    ...
    def cmd(self, value):
        if __debug__:
            assert \
                ...
                "The 'cmd' field must be of type 'bool'"
        self._cmd = value
...
class Metaclass_Gripper(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from gripper_interface.srv import _gripper
...
class Gripper(metaclass=Metaclass_Gripper):
    from gripper_interface.srv._gripper import Gripper_Request as Request
    from gripper_interface.srv._gripper import Gripper_Response as Response
