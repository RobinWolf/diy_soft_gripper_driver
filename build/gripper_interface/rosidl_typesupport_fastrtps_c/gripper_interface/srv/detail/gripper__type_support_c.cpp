...
#include "gripper_interface/srv/detail/gripper__rosidl_typesupport_fastrtps_c.h"
...
#include "gripper_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Gripper_Request__ros_msg_type = gripper_interface__srv__Gripper_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gripper_interface
size_t get_serialized_size_gripper_interface__srv__Gripper_Request(
  const void * untyped_ros_message,
...
static uint32_t _Gripper_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gripper_interface__srv__Gripper_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gripper_interface
size_t max_serialized_size_gripper_interface__srv__Gripper_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gripper_interface__srv__Gripper_Request;
    is_plain =
      (
...
static size_t _Gripper_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gripper_interface__srv__Gripper_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gripper_interface, srv, Gripper_Request)() {
...
using _Gripper_Response__ros_msg_type = gripper_interface__srv__Gripper_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gripper_interface
size_t get_serialized_size_gripper_interface__srv__Gripper_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gripper_Response__ros_msg_type * ros_message = static_cast<const _Gripper_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_gripper_interface__srv__Gripper_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gripper_interface
size_t max_serialized_size_gripper_interface__srv__Gripper_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = gripper_interface__srv__Gripper_Response;
    is_plain =
      (
...
static size_t _Gripper_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gripper_interface__srv__Gripper_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gripper_interface, srv, Gripper_Response)() {
...
// already included above
// #include "gripper_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "gripper_interface/srv/gripper.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gripper_interface, srv, Gripper)() {
