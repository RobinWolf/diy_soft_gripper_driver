...
static const _Gripper_Request_type_support_symbol_names_t _Gripper_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gripper_interface, srv, Gripper_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gripper_interface, srv, Gripper_Request)),
  }
};
...
{
  return &::gripper_interface::srv::rosidl_typesupport_cpp::Gripper_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gripper_interface, srv, Gripper_Request)() {
  return get_message_type_support_handle<gripper_interface::srv::Gripper_Request>();
}
...
static const _Gripper_Response_type_support_symbol_names_t _Gripper_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gripper_interface, srv, Gripper_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gripper_interface, srv, Gripper_Response)),
  }
};
...
{
  return &::gripper_interface::srv::rosidl_typesupport_cpp::Gripper_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gripper_interface, srv, Gripper_Response)() {
  return get_message_type_support_handle<gripper_interface::srv::Gripper_Response>();
}
...
static const _Gripper_type_support_symbol_names_t _Gripper_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gripper_interface, srv, Gripper)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gripper_interface, srv, Gripper)),
  }
};
...
{
  return &::gripper_interface::srv::rosidl_typesupport_cpp::Gripper_service_type_support_handle;
}
